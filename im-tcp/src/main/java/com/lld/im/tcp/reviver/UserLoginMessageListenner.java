 ...
 *
 */
public class UserLoginMessageListenner {

    private final static Logger logger = LoggerFactory.getLogger(UserLoginMessageListenner.class);

    private Integer loginModel;

    public UserLoginMessageListenner(Integer loginModel){
    ...
    public void listenUserLogin(){
        ...
        topic.addListener(String.class, new MessageListener<String>() {
            ...
            public void onMessage(CharSequence channel, String msg) {
                logger.info("UserLoginMessageListenner msg={}",msg);
